            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        ...
                        <a href="{{ route('register.b2b') }}" class="ml-4 text-sm text-gray-700 hover:text-gray-900">{{ __('Register') }}</a>
                    </div>
                @endauth
            </div>
        ...
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('my-reservations')">
                        {{ __('My Reservations') }}
                    </x-responsive-nav-link>
        ...
        @else
            <div class="py-3 border-t border-gray-200">
                <div class="px-4 flex flex-col space-y-2">
                    ...
                    <x-responsive-nav-link :href="route('register.b2b')" :active="request()->routeIs('register.b2b')">
                        {{ __('Register') }}
                    </x-responsive-nav-link>
                </div>
            </div>
