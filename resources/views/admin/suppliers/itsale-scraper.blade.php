                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($latestLists as $list)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $list['total_price'] }}</td>
                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex items-center">
                            <div class="relative mr-2">
                                <input type="text" placeholder="Search lists..." class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
