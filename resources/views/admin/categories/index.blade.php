                    ...
                    <div class="bg-gray-50 p-4 rounded-md border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-semibold text-gray-800">{{ $categories->sum(function ($category) { return $category->products->count(); }) }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-md border border-gray-200 md:col-span-2 lg:col-span-1">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                @endphp
                                @if($mostPopular && $mostPopular->products->count() > 0)
                                    <p class="text-xl font-semibold text-gray-800">{{ $mostPopular->name }} ({{ $mostPopular->products->count() }})</p>
                                @else
                        ...
                        <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
                            ...
                            <div class="bg-gray-50 px-4 py-3 flex justify-between items-center">
                                <div>
                                    ...
                                    <a href="{{ route('admin.categories.edit', $category) }}" class="inline-flex items-center px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    ...
                                    <form method="POST" action="{{ route('admin.categories.destroy', $category) }}" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this category?');">
                                                        @csrf
                                                        @method('DELETE')
                                        <button type="submit" class="inline-flex items-center px-2 py-1 bg-red-100 border border-red-300 rounded text-xs font-medium text-red-700 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" {{ $category->products->count() > 0 ? 'disabled' : '' }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
