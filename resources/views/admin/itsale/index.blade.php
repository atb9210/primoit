                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($latestLists as $list)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $list['description'] }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $list['units'] }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $list['average_price'] }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $list['price'] }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    <a href="{{ route('admin.itsale.show-list', ['supplier' => $supplier, 'listSlug' => strtolower(trim(preg_replace('/[^a-zA-Z0-9]+/', '-', $list['name']), '-'))]) }}" class="text-indigo-600 hover:text-indigo-900">
                                                        Open
                                                    </a>
                                                </td>
                                            </tr>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($allLists as $list)
                                            <tr class="list-item">
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 list-name">{{ $list['name'] }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $list['description'] }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $list['units'] }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $list['average_price'] }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $list['price'] }}</td>
